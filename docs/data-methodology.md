...
- [Sarawak Tribune - SCORE approved investment RM151.5B (Apr 2026)](https://www.sarawaktribune.com/recoda-drives-rm4-5-billion-infrastructure-push-strengthens-rural-connectivity/) - Publisher: Sarawak Tribune; type: news report; date: 1 Apr 2026; quotes the Deputy Premier that approved investments in SCORE have reached RM151.5 billion, involving 655 projects with the potential to generate over 60,000 jobs. The same page supports 243 critical rural infrastructure projects worth RM4.5 billion underway through URDA, HDA and NRDA, and the RM3.8-billion Miri-Marudi-Mulu (Kuala Melinau) and Long Panai-Long Lama road, 142 km, expected completed by 2030.
